                    ...
                    child: DefaultTextStyle(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text('IDENTITY\n',
                            style: TextStyle(
                              fontWeight: FontWeight.bold, // Menjadikan teks menjadi bold
                            ),
                          ),
                          const Text('NIK\t\t\t\t                                              4444\n'),
                          const Text('Name\t\t                                          Tuan Muda\n'),
                          const Text('Sex\t                                                 Male\n'),
                          const Text('Date of Birth\t\t                                02 July\n'),
                          const Text('Address\t                                        Kos Semanggi Soehat'),
